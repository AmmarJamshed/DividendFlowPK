    ...
    >
      ...
      <LegalSection title="What we offer">
        <ul className="list-disc pl-5 space-y-1">
          <li>
            <Link to="/dividend-calendar" className="text-teal-700 hover:underline">Dividend calendar</Link> — payout
            months, indicated yields, and sector coverage
          </li>
          <li>
            <Link to="/market-closing-prices" className="text-teal-700 hover:underline">Market data</Link> — closing
            prices, session movers, and volume
          </li>
          <li>
            <Link to="/reporting-cycles" className="text-teal-700 hover:underline">Reporting cycles</Link> — when
            companies typically announce results
          </li>
          <li>
            <Link to="/forecast-engine" className="text-teal-700 hover:underline">Forecast tools</Link> and{' '}
            <Link to="/salary-simulator" className="text-teal-700 hover:underline">income planner</Link> — illustrative
            models only
          </li>
          <li>
      ...
      <LegalSection title="Who operates this site">
        <p>
          ...
          inquiries, use our{' '}
          <Link to="/contact" className="text-teal-700 hover:underline">Contact</Link> page.
        </p>
      </LegalSection>
      ...
      <LegalSection title="Important notice">
        <p>
          ...
          legal advice. See our <Link to="/terms" className="text-teal-700 hover:underline">Terms of Service</Link> and{' '}
